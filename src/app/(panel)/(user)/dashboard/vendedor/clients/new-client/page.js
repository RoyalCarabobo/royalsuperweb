            ...
            <main className="max-w-5xl mx-auto">
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="bg-[#1a1a1a] p-8 rounded-3xl border border-gray-800 shadow-2xl space-y-6">
                            <h3 className="text-xs font-black uppercase text-blue-500 tracking-widest">Información de Registro</h3>

                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="col-span-2 space-y-1">
                                    <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">Nombre Comercial / Razón Social</label>
                                    <input required className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
                                        onChange={(e) => setForm({ ...form, razon_social: e.target.value })} />
                                </div>

                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">RIF (J-00000000-0)</label>
                                    <input required className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
                                        onChange={(e) => setForm({ ...form, rif: e.target.value })} />
                                </div>

                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">Persona a Cargo</label>
                                    <input required className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
                                ...
                                <div className="space-y-1">
                                    ...
                                    <input required type="tel" className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
                                        onChange={(e) => setForm({ ...form, telefono: e.target.value })} />
                                </div>

                                <div className="space-y-1">
                                    <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">email Corporativo</label>
                                    <input required type="email" className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all"
                                        onChange={(e) => setForm({ ...form, email: e.target.value })} />
                                </div>

                                <div className="col-span-2 space-y-1">
                                    <label className="text-[10px] font-bold text-gray-500 uppercase ml-1">Dirección Física Exacta</label>
                                    <textarea required rows="3" className="w-full bg-[#0f0f0f] border-gray-800 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all resize-none"
